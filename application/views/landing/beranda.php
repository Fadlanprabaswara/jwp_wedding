        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?= base_url('assets/landing/') ?>img/carousel-3.jpeg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <br><strong 
                                    class="text-dark">JeWePe Wedding Organizer</strong></p>
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn">Capturing every moment of your wedding</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="<?= base_url('assets/landing/') ?>img/carousel-4.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Selamat Datang <br><strong 
                                    class="text-dark">JeWePe Wedding Organizer</strong></p>
