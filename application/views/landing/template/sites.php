            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="<?= base_url('About_us') ?>" class="nav-item nav-link <?=($url=='About_us') ? 'active' : ''; ?>">About Us</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>123 Street, Jakarta, Indonesia</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i>+628 134 5647</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i>jwp@gmail.com</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="<?= base_url('About_us') ?>">About Us</a>
                </div>
                <div class="col-lg-3 col-md-6">
