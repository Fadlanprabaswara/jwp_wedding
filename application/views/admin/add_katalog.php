                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    placeholder="Paket Name" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    <label for="exampleSelectStatushPublish">Status Publish</label>
                                    <select class="form-control" id="exampleTextarea1" name="status_publish" >
                            ...
                            <div class="col-lg-12 text-right">
                                <a href="<?= base_url('admin/Katalog')?>" class="btn btn-secondary">Kembali</a>
                                <button type="submit" class="btn btn-warning mr-2">Tambah</button>
                            </div>
                        </div>
                    </form>
                </div>
