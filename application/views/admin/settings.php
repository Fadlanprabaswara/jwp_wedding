                    ...
                    <form action="<?= base_url('admin/Settings/updateData');?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <img src="<?= base_url('assets/files/').$settings->logo?>" style="max-width: 120px;" alt="">
                                </div>
                            </div>
